    ...
    <MainLayout>
      ...
      <div className="min-h-screen bg-slate-950 overflow-hidden">
        ...
        <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-slate-950 via-emerald-950 to-teal-950 animate-gradient" />
          ...
          />
          <motion.div 
            className="absolute bottom-20 right-20 w-[500px] h-[500px] bg-teal-500/30 rounded-full blur-3xl"
            animate={{
              scale: [1.2, 1, 1.2],
              opacity: [0.3, 0.5, 0.3],
            }}
          ...
          />
          <motion.div 
            className="absolute top-1/2 left-1/2 w-[400px] h-[400px] bg-green-500/20 rounded-full blur-3xl"
            animate={{
              scale: [1, 1.3, 1],
              opacity: [0.2, 0.4, 0.2],
            }}
          ...
          {/* Floating shapes */}
          <motion.div
            className="absolute top-32 right-1/4 w-2 h-2 bg-emerald-400"
            animate={{
              y: [0, -20, 0],
              opacity: [0.5, 1, 0.5],
            }}
          ...
          />
          <motion.div
            className="absolute bottom-40 left-1/4 w-3 h-3 bg-teal-400 rotate-45"
            animate={{
              y: [0, 20, 0],
              rotate: [45, 90, 45],
            }}
          ...
          <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
            ...
            >
              <Badge className="mb-6 px-6 py-2 bg-gradient-to-r from-emerald-600 to-teal-600 text-white border-none shadow-2xl">
                <GraduationCap className="w-4 h-4 mr-2 inline" />
                LEARNING CENTER
              </Badge>
              <h1 className="text-5xl md:text-7xl font-black mb-6 text-transparent bg-clip-text bg-gradient-to-r from-emerald-200 via-teal-200 to-green-200">
                Knowledge is Power
              </h1>
